...
public class RedisStringsRepositoryImpl implements RedisStringsRepository {
    ...
    @Override
    @NonNull
    public <S extends RedisStringsEntity> S save(S entity) throws NoSuchElementException {
    ...
    @Override
    @NonNull
    public <S extends RedisStringsEntity> Iterable<S> saveAll(Iterable<S> entities) {
        entities.forEach(this::save);
        return entities;
    }

    @NonNull
    public RedisStringsEntity update(RedisStringsEntity entity) throws NoSuchElementException {
        String key = entity.getKey();
        String value = entity.getValue();
    ...
    @Override
    @NonNull
    public Optional<RedisStringsEntity> findById(@NonNull String key) {
        String value = stringRedisTemplate.opsForValue().get(key);
        if (value != null) {
            return Optional.of(new RedisStringsEntity(key, value));
        }
    ...
    @Override
    @NonNull
    public Iterable<RedisStringsEntity> findAll() {
        List<RedisStringsEntity> res = new ArrayList<>();
    ...
    @Override
    @NonNull
    public Iterable<RedisStringsEntity> findAllById(@NonNull Iterable<String> keys) {
        List<RedisStringsEntity> res = new ArrayList<>();
    ...
    @Override
    public void delete(RedisStringsEntity entity) {
    ...
    @Override
    public void deleteAll(Iterable<? extends RedisStringsEntity> entities) {
