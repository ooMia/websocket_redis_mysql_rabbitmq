...
public class VoteCandidateController implements AbstractCrudController<MemberResponseDto, MemberRequestDto> {

    private final MemberService memberService;

    @Autowired
    public VoteCandidateController(MemberService memberService) {
